...
from rag.workflow.graph import PCISWorkflow
from rag.utils.logger import log_query_start, log_retrieval, log_generation, log_error, Timer
from rag.utils.token_counter import count_tokens
from rag.utils.query_filter_extractor import QueryFilterExtractor
from rag.utils.cache import get_cache
from rag.utils.audit_store import AuditStore
from rag.utils.error_handler import (
    GroqTimeoutError,
    GroqAPIError,
    EmptyRetrievalError,
)
...
class RAGService:
    ...
    async def query(self, user_query: str) -> Dict[str, Any]:
        ...
        if not mongo_records and not vector_docs and not response_text:
            response_text = "No matching records or statistical documents were found in the surveillance database for your query."
